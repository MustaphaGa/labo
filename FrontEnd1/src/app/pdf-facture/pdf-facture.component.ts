...
import { FactureDTO, LaboDTO, PatientDTO } from 'src/gs-api/src/models';
...
factudreDto :FactureDTO= {};
  patientDt: PatientDTO = {};
  labodt:LaboDTO = {};
  constructor(private router: Router,
              private activatedRouter: ActivatedRoute,
              private  factureservices: FacturesService,
  ...
  ngOnInit(): void {
   // console.log(moment(this.patientDt.dateNaissance).format('DD/MM/YYYY'));
    ...
    const idFacture = this.activatedRouter.snapshot.params.idFacture;
    if (idFacture) {
       this.factureservices.findFactureById(idFacture)
       .subscribe(facture => {
         this.factudreDto = facture;
         this.patientDt = this.factudreDto.analyseMedical.reservation.patient;
         console.log(this.factudreDto.analyseMedical.reservation.patient);
        ...
        // sessionStorage.setItem('patientDt', JSON.stringify(this.patientDt));
         return {
           content: [
             ...
             {
               text: 'Facture N :............ ' + '\n' + 'La Date'+ currentDate.toLocaleDateString(),
             ...
             },
             {
...

              {
                columns: [
                   ...
                   {text: '  '+ 'Facture du:' + moment(this.factudreDto.dateFacture).format('DD/MM/YYYY') + '\n', alignment: 'center' }
                  ],
...

                  {
                    ...
                    table: {
                      ...
                      body: [
                       ...
                       [
                         ...
                         {text: [
                           {text: this.factudreDto.montant + ' Dhs \n', italics: true, color: 'red'},
                           {text: moment(this.factudreDto.dateFacture).format('DD/MM/YYYY')  + '  \n' , italics: true, color: 'red'},
                   ...
                   {
                    text: '*************************************************'+'\n'+
                    'Factures valider et vérifier par nos Services pour plus d\'informations contacter nous.'+'\n',
