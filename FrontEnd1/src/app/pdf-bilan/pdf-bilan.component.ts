...
import { BiologisteeService } from '../services/biologiste/biologistee.service';
...
@Component({
  selector: 'app-pdf-bilan',
  templateUrl: './pdf-bilan.component.html',
  styleUrls: ['./pdf-bilan.component.css']
})

export class PdfBilanComponent implements OnInit {

bilanDto :BilanFinancierDTO= {};
                ...
                columns: [
...

                  {
                    ...
                    table: {
                      ...
                      [
                        {text: [
                            {text: 'Total', italics: true , color: 'blue',bold:true },
                              ],
                        },
                       {text: [
                          {text: ' Dhs \n', italics: true},
                     ...
                     [
                      {text: [
                          {text: 'Balance', fontSize: 14,italics: true, color: 'Red',bold:true },
                            ],
                      },
                     {text: [
                        {text: ' Dhs \n', italics: true, },
